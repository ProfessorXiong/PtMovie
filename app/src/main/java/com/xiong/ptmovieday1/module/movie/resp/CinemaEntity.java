...
public class CinemaEntity{
    ...
    /** 区县名称  N  　 黄浦区 */ private String countyname;
    ...
    /** 电影、场次描述  N   放映10部余88场 */ private String countdes;
    /** cp数目  N  支持的比价的cp数目  */ private Integer cpcount;
    /** 价格区间  N  用-分割开，最低价放前面，最高价放后面 33-43 */ private String pricerange;
    private double distance;        //影院地址和当前位置的距离;
